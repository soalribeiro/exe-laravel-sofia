        ...
        <div class="col-md-8">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <footer class="blockquote-footer text-right"><cite title="Source Title">{{ $jornal->user->name }}</cite></footer>
                    <p class="card-text"><strong>Criado em:</strong> {{ $jornal->created_at }} </p>

                    <a href="{{ route('editar-jornal', $jornal->id) }}" class="btn btn-primary">Editar jornal</a>
                </div>
            </div>
